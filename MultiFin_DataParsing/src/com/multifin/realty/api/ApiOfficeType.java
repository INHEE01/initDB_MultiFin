...
//	public static final SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy-MM-dd");
	...
	public static void main(String[] args) {
		//2271개 ..
		//https://api.odcloud.kr/api/ApplyhomeInfoDetailSvc/v1/getUrbtyOfctlLttotPblancMdl?page=1&perPage=10&serviceKey=0AqT6LBbXaBEpVflCkRmxb65gc0GDlTLWpxG6k3OBCdr1BjlFlfb6Rlki8Ym7uqntmpFh%2BQa4u7L3%2FR7t8xn%2Bg%3D%3D
		List<OfficeHouseType> list = parsing("1");

	}

	public static List<OfficeHouseType> parsing(String page) {
